...
import {ProdorderProvider} from '../../providers/prodorder/prodorder';
...
export class AsseblyHomePagePage {
  ...
  constructor(public navCtrl: NavController, private prodorder: ProdorderProvider) {
      this.prodorder.findProductDetails();
  }
